...
export default function HomeClient() {
  ...
  return (
    <main style={{ minHeight: 'calc(100vh - 58px)', background: '#0f172a', color: '#f1f5f9', fontFamily: 'system-ui, sans-serif', overflowX: 'hidden' }}>
          ...
          <div className="hero-inner" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '3rem', flexWrap: 'wrap', justifyContent: 'center', width: '100%' }}>
            ...
            <div className="hero-text" style={{ flex: 1, minWidth: 280, display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '1.25rem', maxWidth: 560 }}>
              <div style={{ display: 'inline-block', background: 'rgba(56,189,248,0.1)', border: '1px solid rgba(56,189,248,0.3)', borderRadius: 999, padding: '0.3rem 1rem', fontSize: '0.75rem', color: '#38bdf8', letterSpacing: '0.06em', fontWeight: 700 }}>
                ✦ BUILT FOR IRELAND · OPEN TO THE WORLD
              </div>
              ...
              <p style={{ fontSize: '1.05rem', color: '#94a3b8', margin: 0, lineHeight: 1.65, maxWidth: 520 }}>
                FreeTrust is Ireland&apos;s community economy marketplace. Buy, sell, hire, and collaborate — and earn TrustCoins (₮) for every contribution. The more you earn, the less you pay in fees and the more visible you become.
              </p>
              ...
              <div className="hero-cta" style={{ display: 'flex', flexDirection: 'row', gap: '0.75rem', flexWrap: 'wrap' }}>
                ...
                <a href="#how-it-works" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(255,255,255,0.05)', color: '#cbd5e1', padding: '0.9rem 1.75rem', borderRadius: 10, fontWeight: 600, fontSize: '0.95rem', textDecoration: 'none', border: '1px solid rgba(148,163,184,0.2)' }}>
                  See how it works ↓
                </a>
              </div>
              ...
              <div style={{ display: 'flex', gap: '1.25rem', flexWrap: 'wrap', fontSize: '0.8rem', color: '#64748b' }}>
                <span style={{ display: 'flex', alignItems: 'center', gap: 5 }}><span style={{ color: '#34d399' }}>✓</span> Free to join — ₮200 welcome bonus</span>
      ...
      {/* ── 3. ABOUT PARAGRAPH (for AI search extraction) ── */}
      {/*
        A single definition paragraph that AI search engines
        (Perplexity, ChatGPT, Google SGE) extract verbatim as the
        answer to "what is FreeTrust?". Kept plain-text with no
        inline styling on the prose itself so crawlers can lift it
        cleanly, and anchored right below the hero where extractors
        expect a definition-style first-paragraph.
      */}
      <section aria-labelledby="about-freetrust" style={{ borderBottom: '1px solid rgba(56,189,248,0.06)', background: 'rgba(15,23,42,0.6)' }}>
        <div className="lp-sec" style={{ paddingTop: '2.25rem', paddingBottom: '2.25rem' }}>
          <h2 id="about-freetrust" style={{ fontSize: 'clamp(1.25rem,2.6vw,1.6rem)', fontWeight: 900, margin: '0 0 0.75rem', letterSpacing: '-0.3px' }}>
            About FreeTrust
          </h2>
          <p style={{ fontSize: '1rem', color: '#cbd5e1', lineHeight: 1.75, margin: 0, maxWidth: 820 }}>
            FreeTrust is Ireland&apos;s community economy marketplace — a single platform for freelancers, small businesses, community organisers, and nonprofits to sell services, list products, post jobs, run events, build communities, and collaborate. Every contribution earns TrustCoins (₮), a reputation currency that lowers your fees, boosts your visibility, and unlocks community features. 1% of every real-money transaction funds the Sustainability Fund, a community-governed pool supporting reforestation, clean energy, and other impact projects. Built in Ireland, open to members worldwide.
          </p>
        </div>
      </section>
      ...
      {/* ── HOW IT WORKS ── */}
      <section id="how-it-works" aria-labelledby="how-it-works-heading" style={{ borderBottom: '1px solid rgba(56,189,248,0.06)' }}>
        <div className="lp-sec">
          <div style={{ textAlign: 'center', marginBottom: '2.25rem' }}>
            <div style={{ display: 'inline-block', fontSize: '0.7rem', fontWeight: 800, color: '#34d399', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '0.5rem' }}>How it works</div>
            <h2 id="how-it-works-heading" className="section-h2" style={{ fontSize: 'clamp(1.5rem,3.5vw,2.2rem)', fontWeight: 900, margin: 0, letterSpacing: '-0.5px' }}>
              From sign-up to earning in 4 steps
            </h2>
            <p style={{ color: '#64748b', margin: '0.6rem auto 0', maxWidth: 560, fontSize: '0.92rem', lineHeight: 1.6 }}>
              No subscription, no gatekeeping — just create your profile and start contributing. Every action is rewarded.
            </p>
          </div>
          <div className="how-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: '1rem' }}>
            {[
              { n: '1', icon: '👤', title: 'Sign up and build your profile', desc: 'Free in 60 seconds — verify your email, add a photo and bio, and claim your ₮200 welcome bonus.' },
              { n: '2', icon: '📦', title: 'List your services, products, or jobs', desc: 'Open a gig, a shop, or post a job. Your first listing earns ₮50 and appears in the browse pages instantly.' },
              { n: '3', icon: '🤝', title: 'Connect, collaborate, earn ₮', desc: 'Get hired, sell products, host events, or publish articles. Every contribution earns TrustCoins automatically.' },
              { n: '4', icon: '🚀', title: 'Spend ₮ to grow', desc: 'Boost listings, feature your profile, donate to the Sustainability Fund, or unlock badges — all paid in ₮.' },
            ].map(step => (
              <div key={step.n} style={{ background: '#1e293b', border: '1px solid rgba(56,189,248,0.08)', borderRadius: 14, padding: '1.4rem 1.2rem', position: 'relative' }}>
                <div style={{ position: 'absolute', top: -12, left: 16, background: 'linear-gradient(135deg,#38bdf8,#0284c7)', color: '#0f172a', fontWeight: 900, fontSize: '0.78rem', padding: '0.3rem 0.7rem', borderRadius: 999, letterSpacing: '0.04em' }}>
                  STEP {step.n}
                </div>
                <div style={{ fontSize: '1.8rem', marginTop: '0.3rem', marginBottom: '0.55rem' }}>{step.icon}</div>
                <h3 style={{ fontSize: '0.95rem', fontWeight: 800, color: '#f1f5f9', margin: '0 0 0.35rem' }}>{step.title}</h3>
                <p style={{ fontSize: '0.82rem', color: '#64748b', lineHeight: 1.55, margin: 0 }}>{step.desc}</p>
              </div>
            ))}
          </div>
          <style>{`
            @media (max-width: 900px) { .how-grid { grid-template-columns: repeat(2,1fr) !important; } }
            @media (max-width: 520px) { .how-grid { grid-template-columns: 1fr !important; } }
          `}</style>
        </div>
      </section>

      {/* ── FEATURES GRID ── */}
      <section aria-labelledby="features-heading" style={{ borderBottom: '1px solid rgba(56,189,248,0.06)', background: 'rgba(56,189,248,0.02)' }}>
        <div className="lp-sec">
          <div style={{ textAlign: 'center', marginBottom: '2.25rem' }}>
            <div style={{ display: 'inline-block', fontSize: '0.7rem', fontWeight: 800, color: '#38bdf8', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Features</div>
            <h2 id="features-heading" className="section-h2" style={{ fontSize: 'clamp(1.5rem,3.5vw,2.2rem)', fontWeight: 900, margin: 0, letterSpacing: '-0.5px' }}>
              What you can do on FreeTrust
            </h2>
            <p style={{ color: '#64748b', margin: '0.6rem auto 0', maxWidth: 560, fontSize: '0.92rem', lineHeight: 1.6 }}>
              Eight tools, one platform, one account. No need to juggle five SaaS subscriptions.
            </p>
          </div>
          <div className="feat-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: '0.85rem' }}>
            {[
              { icon: '🛒', title: 'Marketplace',        desc: 'Sell physical and digital products with Stripe checkout and 1-2 day bank payouts.', href: '/products' },
              { icon: '🧑‍💻', title: 'Services',           desc: 'Gig-style listings for freelance work — design, dev, marketing, trades, home services.', href: '/services' },
              { icon: '💼', title: 'Jobs board',         desc: 'Post full-time, part-time, or contract roles. First job post earns ₮30.', href: '/jobs' },
              { icon: '🎫', title: 'Events',             desc: 'Host workshops, meet-ups, or classes. Ticketed or free. Earn ₮50 per event.', href: '/events' },
              { icon: '👥', title: 'Communities',        desc: 'Create free or paid communities with their own feed, events, and member list.', href: '/community' },
              { icon: '📣', title: 'Social feed',        desc: 'Share updates, articles, and resources. Earn ₮ for every like on your first 10 likes.', href: '/feed' },
              { icon: '₮',  title: 'Trust economy',     desc: 'Every action rewards you with TrustCoins. Lower fees + better visibility for active members.', href: '/wallet' },
              { icon: '🌱', title: 'Sustainability Fund', desc: 'Donate ₮ to fund reforestation, clean energy, and other community impact projects.', href: '/impact' },
            ].map(f => (
              <Link
                key={f.title}
                href={f.href}
                ...
                onMouseEnter={e => { (e.currentTarget as HTMLElement).style.transform='translateY(-2px)'; (e.currentTarget as HTMLElement).style.borderColor='rgba(56,189,248,0.28)'; (e.currentTarget as HTMLElement).style.boxShadow='0 8px 24px rgba(56,189,248,0.1)' }}
                onMouseLeave={e => { (e.currentTarget as HTMLElement).style.transform=''; (e.currentTarget as HTMLElement).style.borderColor='rgba(56,189,248,0.08)'; (e.currentTarget as HTMLElement).style.boxShadow='' }}
              >
                <div style={{ fontSize: '1.6rem', lineHeight: 1 }}>{f.icon}</div>
                <h3 style={{ fontSize: '0.92rem', fontWeight: 800, color: '#f1f5f9', margin: 0 }}>{f.title}</h3>
                <p style={{ fontSize: '0.78rem', color: '#64748b', lineHeight: 1.5, margin: 0 }}>{f.desc}</p>
              </Link>
            ))}
          </div>
          <style>{`
            @media (max-width: 960px) { .feat-grid { grid-template-columns: repeat(2,1fr) !important; } }
      ...
      <section aria-labelledby="trust-economy-heading" style={{ borderBottom: '1px solid rgba(56,189,248,0.06)' }}>
        <div className="lp-sec">
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            <div style={{ display: 'inline-block', fontSize: '0.7rem', fontWeight: 800, color: '#2dd4bf', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '0.5rem' }}>The Trust Economy</div>
            <h2 id="trust-economy-heading" className="section-h2" style={{ fontSize: 'clamp(1.5rem,3.5vw,2.2rem)', fontWeight: 900, margin: 0, letterSpacing: '-0.5px' }}>
              What are TrustCoins (₮)?
            </h2>
            <p style={{ color: '#94a3b8', margin: '0.6rem auto 0', maxWidth: 640, fontSize: '0.95rem', lineHeight: 1.65 }}>
              TrustCoins are FreeTrust&apos;s reputation currency. They reward real contribution — not vanity engagement — and give active members compounding benefits: lower fees, better visibility, priority support, and unlockable perks.
            </p>
          </div>

          <div className="te-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
            {/* Earn */}
            <div style={{ background: 'linear-gradient(135deg, rgba(52,211,153,0.08), rgba(45,212,191,0.04))', border: '1px solid rgba(52,211,153,0.2)', borderRadius: 14, padding: '1.4rem 1.3rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.9rem' }}>
                <span style={{ fontSize: '1.3rem' }}>⬇</span>
                <h3 style={{ fontSize: '1.05rem', fontWeight: 900, color: '#34d399', margin: 0, letterSpacing: '-0.2px' }}>How to earn ₮</h3>
              </div>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.55rem' }}>
                {[
                  { label: 'Sign up',                  amt: TRUST_REWARDS.SIGNUP_BONUS },
                  { label: 'Complete your profile',    amt: TRUST_REWARDS.COMPLETE_PROFILE },
                  { label: 'Create a service listing', amt: TRUST_REWARDS.CREATE_SERVICE },
                  { label: 'List a product',           amt: TRUST_REWARDS.CREATE_PRODUCT },
                  { label: 'Post a job',               amt: TRUST_REWARDS.CREATE_JOB },
                  { label: 'Create an event',          amt: TRUST_REWARDS.CREATE_EVENT },
                  { label: 'Publish an article',       amt: TRUST_REWARDS.PUBLISH_ARTICLE },
                  { label: 'Create a community',       amt: TRUST_REWARDS.CREATE_COMMUNITY },
                  { label: 'Complete an order',        amt: TRUST_REWARDS.COMPLETE_ORDER },
                  { label: 'Receive a review',         amt: TRUST_REWARDS.RECEIVE_REVIEW },
                  { label: 'Refer a new member',       amt: TRUST_REWARDS.REFER_USER },
                ].map(row => (
                  <li key={row.label} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontSize: '0.85rem', color: '#cbd5e1', paddingBottom: '0.45rem', borderBottom: '1px dashed rgba(52,211,153,0.15)' }}>
                    <span>{row.label}</span>
                    <span style={{ color: '#34d399', fontWeight: 800 }}>+₮{row.amt}</span>
                  </li>
                ))}
              </ul>
            </div>
            ...
            {/* Spend */}
            <div style={{ background: 'linear-gradient(135deg, rgba(56,189,248,0.08), rgba(129,140,248,0.04))', border: '1px solid rgba(56,189,248,0.2)', borderRadius: 14, padding: '1.4rem 1.3rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.9rem' }}>
                <span style={{ fontSize: '1.3rem' }}>⬆</span>
                <h3 style={{ fontSize: '1.05rem', fontWeight: 900, color: '#38bdf8', margin: 0, letterSpacing: '-0.2px' }}>What to spend ₮ on</h3>
              </div>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.55rem' }}>
                {[
                  { label: 'Boost a listing for 7 days', amt: 200, sub: 'Pin to the top of browse pages' },
                  { label: 'Offset platform fees',       amt: 100, sub: '₮100 = €1 credit on seller fees' },
                  { label: 'Donate to Sustainability Fund', amt: 50, sub: 'Fund real-world impact projects' },
                  { label: 'Unlock Early Supporter badge', amt: 150, sub: 'Permanent profile badge' },
                  { label: 'Feature your profile',       amt: 300, sub: '3 days in the top members carousel' },
                ].map(row => (
                  <li key={row.label} style={{ fontSize: '0.85rem', color: '#cbd5e1', paddingBottom: '0.55rem', borderBottom: '1px dashed rgba(56,189,248,0.15)' }}>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                      <span style={{ fontWeight: 600 }}>{row.label}</span>
                      <span style={{ color: '#38bdf8', fontWeight: 800 }}>₮{row.amt}</span>
                    </div>
                    <div style={{ fontSize: '0.72rem', color: '#64748b', marginTop: '0.15rem' }}>{row.sub}</div>
                  </li>
                ))}
              </ul>
            </div>
          ...
          <p style={{ textAlign: 'center', fontSize: '0.82rem', color: '#64748b', marginTop: '1.5rem', maxWidth: 640, marginLeft: 'auto', marginRight: 'auto', lineHeight: 1.65 }}>
            Why does it matter? Because rewarding contribution — not just clicks — builds a marketplace where the loudest voice isn&apos;t always the one that wins. Members with higher Trust get better visibility, lower fees, and first access to new features.
          </p>

          <style>{`
            @media (max-width: 860px) { .te-grid { grid-template-columns: 1fr !important; } }
          `}</style>
        </div>
      </section>

      {/* ── WHO IS FREETRUST FOR? ── */}
      <section aria-labelledby="personas-heading" style={{ borderBottom: '1px solid rgba(56,189,248,0.06)', background: 'rgba(129,140,248,0.03)' }}>
        <div className="lp-sec">
          <div style={{ textAlign: 'center', marginBottom: '2.25rem' }}>
            <div style={{ display: 'inline-block', fontSize: '0.7rem', fontWeight: 800, color: '#a78bfa', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Who it&apos;s for</div>
            <h2 id="personas-heading" className="section-h2" style={{ fontSize: 'clamp(1.5rem,3.5vw,2.2rem)', fontWeight: 900, margin: 0, letterSpacing: '-0.5px' }}>
              Who is FreeTrust for?
            </h2>
          </div>
          <div className="persona-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: '1rem' }}>
            {[
              { icon: '🧑‍💻', title: 'Freelancers & service providers',         desc: 'Open a gig, get paid through escrow, build reputation you own.', benefit: 'Lower fees as your Trust grows.', cta: 'Open a gig →' },
              { icon: '🏪',  title: 'Small businesses & makers',                desc: 'Sell physical + digital products with Stripe checkout and bank payouts.', benefit: 'No monthly subscription.', cta: 'List a product →' },
              { icon: '📣',  title: 'Community organisers & event hosts',       desc: 'Run ticketed or free events, build a community, post updates to a shared feed.', benefit: 'Reward members with ₮.', cta: 'Host an event →' },
              { icon: '💚',  title: 'Nonprofits & social enterprises',          desc: 'Get listed in the organisations directory, receive donations via the Sustainability Fund.', benefit: 'Direct donations + reach.', cta: 'Create an org →' },
            ].map(p => (
              <div key={p.title} style={{ background: '#1e293b', border: '1px solid rgba(167,139,250,0.2)', borderRadius: 14, padding: '1.4rem 1.2rem', display: 'flex', flexDirection: 'column' }}>
                <div style={{ fontSize: '1.9rem', lineHeight: 1, marginBottom: '0.65rem' }}>{p.icon}</div>
                <h3 style={{ fontSize: '0.95rem', fontWeight: 800, color: '#f1f5f9', margin: '0 0 0.4rem', lineHeight: 1.3 }}>{p.title}</h3>
                <p style={{ fontSize: '0.8rem', color: '#94a3b8', lineHeight: 1.55, margin: '0 0 0.65rem' }}>{p.desc}</p>
                <div style={{ fontSize: '0.72rem', color: '#34d399', fontWeight: 700, marginBottom: '0.9rem' }}>✓ {p.benefit}</div>
                <Link href="/register" style={{ marginTop: 'auto', fontSize: '0.78rem', color: '#a78bfa', fontWeight: 700, textDecoration: 'none' }}>
                  {p.cta}
                </Link>
              </div>
            ))}
          ...
          <style>{`
            @media (max-width: 960px) { .persona-grid { grid-template-columns: repeat(2,1fr) !important; } }
            @media (max-width: 520px) { .persona-grid { grid-template-columns: 1fr !important; } }
          `}</style>
        </div>
      </section>

      {/* ── FAQ ── */}
      <section id="faq" aria-labelledby="faq-heading" style={{ borderBottom: '1px solid rgba(56,189,248,0.06)' }}>
        <div className="lp-sec" style={{ maxWidth: 820 }}>
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            <div style={{ display: 'inline-block', fontSize: '0.7rem', fontWeight: 800, color: '#fbbf24', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '0.5rem' }}>FAQ</div>
            <h2 id="faq-heading" className="section-h2" style={{ fontSize: 'clamp(1.5rem,3.5vw,2.2rem)', fontWeight: 900, margin: 0, letterSpacing: '-0.5px' }}>
              Frequently asked questions
            </h2>
            <p style={{ color: '#64748b', margin: '0.6rem auto 0', maxWidth: 540, fontSize: '0.92rem', lineHeight: 1.6 }}>
              Everything you need to know before joining. Still not sure? Email <a href="mailto:support@freetrust.co" style={{ color: '#38bdf8', textDecoration: 'none' }}>support@freetrust.co</a>.
            </p>
          </div>

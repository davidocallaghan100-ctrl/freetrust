...
const CATEGORY_RULES: Array<{ category: string; patterns: RegExp[] }> = [
  ...
  { category: 'Travel', patterns: [/\btravel\b/i, /\btours?\b/i, /\btourism\b/i] },
  { category: 'Outdoors & Adventure', patterns: [/\boutdoor\b/i, /\badventure\b/i, /\bhiking\b/i, /\bwalking\b/i, /\bnature\b/i] },
...
export function normalizeEventCategory(category?: string | null, haystack = ''): string {
  ...
  const direct: Record<string, string> = {
    ...
    'Family & Education': 'Parents & Family',

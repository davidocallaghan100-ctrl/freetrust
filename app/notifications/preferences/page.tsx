...
export default function NotificationPreferencesPage() {
  ...
  return (
    <>
      <style>{`
        .np-page { min-height: 100vh; background: var(--ft-bg); padding: 2rem 1.25rem; }
        .np-inner { max-width: 600px; margin: 0 auto; }
        .np-back { display: inline-flex; align-items: center; gap: 0.4rem; color: var(--ft-text-tertiary); text-decoration: none; font-size: 0.85rem; font-weight: 500; margin-bottom: 1.5rem; transition: color 0.15s; }
        .np-back:hover { color: var(--ft-text-secondary); }
        .np-title { font-size: 1.6rem; font-weight: 900; color: var(--ft-text); margin-bottom: 0.35rem; }
        .np-sub { font-size: 0.88rem; color: var(--ft-text-tertiary); margin-bottom: 1.75rem; }
        .np-card { background: var(--ft-surface); border: 1px solid rgba(56,189,248,0.1); border-radius: 12px; overflow: hidden; margin-bottom: 1.25rem; }
        .np-card-title { font-size: 0.75rem; font-weight: 700; color: var(--ft-text-tertiary); text-transform: uppercase; letter-spacing: 0.06em; padding: 0.85rem 1.25rem 0.5rem; }
        ...
        .np-row-label { font-size: 0.9rem; font-weight: 600; color: var(--ft-text); }
        .np-row-desc { font-size: 0.78rem; color: var(--ft-text-tertiary); margin-top: 0.1rem; }
        ...
        .np-toggle input:checked + .np-toggle-track { background: var(--ft-accent); }
        .np-toggle-thumb {
          position: absolute;
          top: 3px;
          left: 3px;
      ...
      <main className="np-page">
        <div className="np-inner">
          ...
          {loading ? (
            <div style={{ background: 'var(--ft-surface)', borderRadius: 12, padding: '3rem', textAlign: 'center', color: 'var(--ft-text-tertiary)', border: '1px solid rgba(56,189,248,0.1)' }}>
              Loading preferences...
            </div>
          ) : (
            <>

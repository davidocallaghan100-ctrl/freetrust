...
// No mock data — articles page shows only real published articles from DB
...
export default function ArticlesPage() {
  ...
  const allArticles: DBArticle[] = dbArticles ?? []
  const featured: DBArticle | null = allArticles[0] ?? null
  const rest: DBArticle[] = allArticles.length > 1 ? allArticles.slice(1) : []

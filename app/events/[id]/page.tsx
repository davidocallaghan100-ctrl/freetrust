...
export default function EventDetailPage() {
  ...
  return (
    <div style={S.page}>
      <style>{`
        .evdetail-layout { display: grid; grid-template-columns: 1fr 300px; gap: 2rem; align-items: start; }
        .evdetail-sidebar { position: sticky; top: 78px; }
        .evdetail-infogrid { display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 1rem; margin-top: 1.5rem; }
        .evdetail-speakers { display: grid; grid-template-columns: repeat(auto-fill, minmax(120px, 1fr)); gap: 1rem; }
        .evdetail-inner { max-width: 1100px; margin: 0 auto; padding: 2rem 1.5rem; }
        .evdetail-hero-inner { max-width: 1100px; margin: 0 auto; }
        @media (max-width: 768px) {
          .evdetail-layout { grid-template-columns: 1fr !important; }
          .evdetail-sidebar { position: static; top: auto; }
          .evdetail-infogrid { grid-template-columns: 1fr 1fr !important; }
          .evdetail-speakers { grid-template-columns: repeat(2, 1fr) !important; }
          .evdetail-inner { padding: 1.25rem 1rem !important; }
          .evdetail-hero { padding: 1.5rem 1rem !important; }
          .evdetail-hero-inner { padding: 0 !important; }
          .evdetail-title { font-size: 1.4rem !important; }
        }
      `}</style>
      <div className="evdetail-hero" style={S.hero}>
        <div className="evdetail-hero-inner" style={S.heroInner}>
          ...
          <h1 className="evdetail-title" style={S.heroTitle}>{event.title}</h1>
          <div className="evdetail-infogrid" style={S.infoGrid}>
      ...
      <div className="evdetail-inner" style={S.inner}>
        <div className="evdetail-layout" style={S.layout}>
          <main style={S.main}>
            <div style={S.section}>
            ...
            <div style={S.section}>
              ...
              <div className="evdetail-speakers" style={S.speakerGrid}>
          ...
          <aside className="evdetail-sidebar" style={S.sidebar}>

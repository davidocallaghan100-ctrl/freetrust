...
export default function EventsPage() {
  ...
  return (
    <div style={S.page}>
      <style>{`
        .events-content { display: grid; grid-template-columns: 1fr 280px; gap: 2rem; max-width: 1200px; margin: 0 auto; padding: 2rem 1.5rem; align-items: start; }
        .events-sidebar { display: flex; flex-direction: column; gap: 1.25rem; position: sticky; top: 78px; }
        .events-card-footer { display: flex; align-items: center; gap: 1rem; flex-wrap: wrap; }
        .events-reg-btn { background: #38bdf8; border: none; border-radius: 7px; padding: 0.45rem 1.1rem; font-size: 0.82rem; font-weight: 700; color: #0f172a; cursor: pointer; margin-left: auto; }
        @media (max-width: 768px) {
          .events-content { grid-template-columns: 1fr !important; padding: 1rem !important; gap: 1rem !important; }
          .events-sidebar { display: none !important; }
          .events-hero { padding: 1.5rem 1rem 1.25rem !important; }
          .events-card-footer { gap: 0.5rem; }
          .events-reg-btn { margin-left: 0; width: 100%; text-align: center; }
          .events-card { padding: 1rem !important; }
          .events-filter-row { gap: 0.35rem !important; }
        }
      `}</style>
      <div className="events-hero" style={S.hero}>
        <div style={S.inner}>
      ...
      <div className="events-content" style={S.content}>
        <div style={S.list}>
        ...
        {/* Sidebar */}
        <aside className="events-sidebar" style={S.sidebar}>
